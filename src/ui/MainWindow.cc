...
void MainWindow::buildCommonWidgets()
{
    ...
    createDockWidget(engineeringView,new HUD2(320,240,this),tr("Video Downlink 2"),"HEAD_UP_DISPLAY_2_DOCKWIDGET",VIEW_ENGINEER,Qt::RightDockWidgetArea,QSize(this->width()/1.5,0));
